...
<ul class="list bg-base-100 rounded-box shadow-md w-3/6 mx-auto mt-30 mb-20">
    <li class="list-row">
        <div>
            <h2 class="text-2xl font-bold mb-10 text-center w-full" >Les séries disponibles</h2>
        </div>
    </li>
    <?php
    ...
    foreach ($series as $serie) {
        ...
        <li class="list-row w-full flex justify-between items-center">
            <div class="flex justify-between items-center w-full">
                ...
                <a href="details-serie.php?nom=<?= $serie['id'] ?>" class="btn">Voir les détails</a>
            </div>
        </li>
        <?php
    }
